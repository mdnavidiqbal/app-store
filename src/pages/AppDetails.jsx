...
//                 {app.downloads.toLocaleString()} <br />{" "}
...
//                 {" "}
//                 <ScanEye></ScanEye>
//                 {app.reviews} <br /> <span className="font-bold">Reviews</span>{" "}
//               </div>
//             </div>{" "}
//             <br /> <hr />
//             <section className="mt-6">
//               <h3 className="font-semibold mb-2">Reviews breakdown</h3>
